        ...
        <div class="col-12 col-lg-6 bg-white rounded-2">
            <div class="mt-4">
                <div class=" p-4">
                    ...
                    @if ($data['list']->count() > 0)
                        ...
                        {{-- <div class="row mb-2">
                            <div class="col-12">
                                ...
                                <!-- Input untuk mencari Tenant -->
                                <div class="input-group mb-3">
                                    <input type="text" id="search" class="form-control" placeholder="Cari Tenant..."
                                        aria-label="Cari berdasarkan Tenant..." aria-describedby="search">
                                </div>
                            </div>
                            <div class="col-12">
                    ...
                    @else
                        <!-- Pesan jika belum ada data Tenant -->
